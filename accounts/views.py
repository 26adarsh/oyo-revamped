...
# -------------------------------------------------------------------
# AUTHENTICATION VIEWS (HotelUser)
# -------------------------------------------------------------------
...
def logout_view(request):
    logout(request)
    return redirect('login_page')  # or redirect('/') if you want home page
...
def register(request):
    if request.method == "POST":
        ...
        messages.success(request, "An email has been sent to your address")
        return redirect('/account/register/')
...
# -------------------------------------------------------------------
# AUTHENTICATION VIEWS (HotelVendor)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# DASHBOARD AND HOTEL MANAGEMENT
# -------------------------------------------------------------------
